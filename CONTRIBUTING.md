# Contributing to LGBTQ Definitions
...
1. Search [LGBTQ Definitions](https://github.com/monacodelisa/LGBTQ-definitions/pulls) for an open or closed PR that relates to your submission.
...
3. [Fork](https://docs.github.com/en/github/getting-started-with-github/fork-a-repo) the `LGBTQ Definitions` repo.
...
7. Run the full test suite, as described in the mainer documentation, and ensure that all tests pass.
...
10. In GitHub, send a pull request to `monacodelisa/LGBTQ-definitions:main`.
